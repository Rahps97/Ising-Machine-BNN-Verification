...
iterable_args.adaptive_avg_pool_shape = [4]
...
# iterable_args.pixels_to_perturb_len = [7, 15, 31, 63]
iterable_args.pixels_to_perturb_len = [7]
...
args.export_H = True
"""
- Percentage of images that we can find adversarial examples for
- Percentage of solutions that satisfy the constraints for each image

---
- Use args or sth like that for logging the parameters
- Use results={} to keep all the results
- Make parameters we want to iterate a list
